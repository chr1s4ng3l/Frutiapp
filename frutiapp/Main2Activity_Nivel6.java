...
public class Main2Activity_Nivel6 extends AppCompatActivity {
    ...
    private ImageView ivAuno, ivAdos, ivVidas, iv_Signo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Nivel 6 - Operaciones ramdom", Toast.LENGTH_SHORT).show();
    ...
    public void NumAleatorio(){
        ...
        if(score <= 1000){
            ...
            Intent intent = new Intent(this, MainActivity.class);
            Toast.makeText(this, "Felicidades!!!! Has Terminado el juego!!!", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            finish();
            mp.stop();
            mp.release();
